...
import kotlinx.android.synthetic.main.activity_chap5_user_details_item.view.cellLayour
import kotlinx.android.synthetic.main.activity_chap5_user_details_item.view.lblEmail
import kotlinx.android.synthetic.main.activity_chap5_user_details_item.view.lbluserName
import kotlinx.android.synthetic.main.activity_chap5_user_details_item.view.userAvtar
...
class UserDataAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): UserDataViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.activity_chap5_user_details_item, parent, false)
